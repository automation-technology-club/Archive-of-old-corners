...
#define Ycenter      20   // Y image center (Servo position in degrees)
#define SETTIME     100   // Servo Setting Time in milliseconds.
...
float readTemp(){
  ...
  return  3*(100+int(diffTemp));   // value range ajusted experimentally.
}
